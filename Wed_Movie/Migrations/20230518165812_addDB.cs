        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PhimId = table.Column<string>(type: "nvarchar(128)", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    IdDienVien = table.Column<string>(type: "nvarchar(450)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IdPhim = table.Column<string>(type: "nvarchar(128)", nullable: false),
                    PhanPhimId = table.Column<string>(type: "nvarchar(128)", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_CT_Hangs", x => new { x.IdPhim, x.IdHang });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CT_TheLoais", x => new { x.IdPhim, x.IdTheLoai });
                    table.ForeignKey(
