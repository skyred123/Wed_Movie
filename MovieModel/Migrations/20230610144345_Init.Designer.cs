...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Wed_Movie.Entities.ApplicationUser", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("Wed_Movie.Entities.CT_DienVien", b =>
                {
            ...
            modelBuilder.Entity("Wed_Movie.Entities.CT_Hang", b =>
                {
                    b.Property<string>("IdPhanPhim")
                        .HasColumnType("nvarchar(128)")
                        .HasColumnOrder(2);
            ...
            modelBuilder.Entity("Wed_Movie.Entities.CT_TheLoai", b =>
                {
                    b.Property<string>("IdPhanPhim")
                        .HasColumnType("nvarchar(128)")
                        .HasColumnOrder(2);
            ...
            modelBuilder.Entity("Wed_Movie.Entities.DienVien", b =>
                {
                    b.Property<string>("Id")
                        .HasMaxLength(128)
                        .HasColumnType("nvarchar(128)");
            ...
            modelBuilder.Entity("Wed_Movie.Entities.Hang", b =>
                {
                    b.Property<string>("Id")
                        .HasMaxLength(128)
                        .HasColumnType("nvarchar(128)");
            ...
            modelBuilder.Entity("Wed_Movie.Entities.PhanPhim", b =>
                {
                    b.Property<string>("Id")
                        .HasMaxLength(128)
                        .HasColumnType("nvarchar(128)");
            ...
            modelBuilder.Entity("Wed_Movie.Entities.Phim", b =>
                {
                    b.Property<string>("Id")
                        .HasMaxLength(128)
                        .HasColumnType("nvarchar(128)");
            ...
            modelBuilder.Entity("Wed_Movie.Entities.TapPhim", b =>
                {
                    b.Property<string>("Id")
                        .HasMaxLength(128)
                        .HasColumnType("nvarchar(128)");
            ...
            modelBuilder.Entity("Wed_Movie.Entities.TheLoai", b =>
                {
                    b.Property<string>("Id")
                        .HasMaxLength(128)
                        .HasColumnType("nvarchar(128)");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("Wed_Movie.Entities.ApplicationUser", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Wed_Movie.Entities.CT_DienVien", b =>
                {
                    b.HasOne("Wed_Movie.Entities.DienVien", "DienVien")
                        .WithMany("CT_DienViens")
                        .HasForeignKey("IdDienVien")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Wed_Movie.Entities.PhanPhim", "PhanPhim")
            ...
            modelBuilder.Entity("Wed_Movie.Entities.CT_Hang", b =>
                {
                    b.HasOne("Wed_Movie.Entities.Hang", "Hang")
                        .WithMany("CT_Hang")
            ...
            modelBuilder.Entity("Wed_Movie.Entities.CT_TheLoai", b =>
                {
                    ...
                    b.HasOne("Wed_Movie.Entities.TheLoai", "TheLoai")
                        .WithMany("CT_TheLoais")
            ...
            modelBuilder.Entity("Wed_Movie.Entities.PhanPhim", b =>
                {
                    b.HasOne("Wed_Movie.Entities.Phim", "Phim")
                        .WithMany("PhanPhim")
